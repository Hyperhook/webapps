...
public List<Cliente> listarClientes()throws Exception{
	...
	try{
		...
		stmt = con.prepareStatement("select usuario.email,usuario.nome,cliente.cpf from usuario,cliente "
				+ "where usuario.email = cliente.id_email and "
				+ "usuario.perfil = 'CLI'" );
...
/* Listar Clientes */
public List<Cliente> listarClientesAjax(String nome)throws Exception{
	...
	try{
		...
		//on funcionario.id_cargo = cargo.idcargo
		...
		stmt = con.prepareStatement("select usuario.email,usuario.nome,cliente.cpf from usuario,cliente "
				+ "where usuario.email = cliente.id_email and "
				+ "usuario.perfil = 'CLI' and usuario.nome like ?");
